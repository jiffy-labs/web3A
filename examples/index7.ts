...
const network = Network.EDU_TESTNET;
...
console.log(publicClient.chain?.rpcUrls.default.http[0]);
...
console.log("owner account", privateKeyToAccount(privateKey).address);
